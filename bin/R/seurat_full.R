...
# Change plot path
curr.plot_path <- paste0(plot_path, '0_filt_data/')
dir.create(curr.plot_path)
...
png(paste0(curr.plot_path, "dimHM.png"), width=30, height=50, units = 'cm', res = 200)
...
png(paste0(curr.plot_path, "elbowplot.png"), width=24, height=20, units = 'cm', res = 200)
...
png(paste0(curr.plot_path, "UMAP_PCA_comparison.png"), width=40, height=30, units = 'cm', res = 200)
...
png(paste0(curr.plot_path, "UMAP.png"), width=40, height=20, units = 'cm', res = 200)
clust.stage.plot(norm.data)
graphics.off()

# Plot QC for each cluster
png(paste0(curr.plot_path, "cluster.QC.png"), width=40, height=14, units = 'cm', res = 200)
QC.plot(norm.data)
graphics.off()
...
png(paste0(curr.plot_path, 'HM.top15.DE.png'), height = 50, width = 75, units = 'cm', res = 700)
...
# Change plot path
curr.plot_path <- paste0(plot_path, '1_sex_filt/')
dir.create(curr.plot_path)
...
png(paste0(curr.plot_path, 'HM.top15.DE.pre-sexfilt.png'), height = 40, width = 70, units = 'cm', res = 500)
...
png(paste0(curr.plot_path, "clustree.png"), width=70, height=35, units = 'cm', res = 200)
...
png(paste0(curr.plot_path, 'HM.top15.DE.post-sexfilt.png'), height = 75, width = 100, units = 'cm', res = 500)
...
# Change plot path
curr.plot_path <- paste0(plot_path, "2_contamination_filt/")
dir.create(curr.plot_path)
...
ncol = 3
png(paste0(curr.plot_path, "UMAP_GOI.png"), width = ncol*10, height = 10*ceiling((length(genes)+2)/ncol), units = "cm", res = 200)
...
png(paste0(curr.plot_path, "dotplot.GOI.png"), width = 20, height = 12, units = "cm", res = 200)
...
# Plot QC for each cluster
png(paste0(curr.plot_path, "cluster.QC.png"), width=45, height=14, units = 'cm', res = 200)
...
# Change plot path
curr.plot_path <- paste0(plot_path, "3_cluster_filt/")
dir.create(curr.plot_path)
...
# Set plot path
curr.plot_path <- paste0(plot_path, "4_cell_cycle/")
dir.create(curr.plot_path)
...
png(paste0(curr.plot_path, "cell.cycle.png"), width=40, height=20, units = 'cm', res = 200)
...
png(paste0(curr.plot_path, 'HM.top15.DE.png'), height = 75, width = 100, units = 'cm', res = 500)
...
# Set plot path
curr.plot_path <- paste0(plot_path, "5_cell_state_classification/")
dir.create(curr.plot_path)

saveRDS(norm.data.clustfilt.cc, paste0(rds_path, "norm.data.clustfilt.cc.RDS"))
...
# Set plot path
curr.plot_path <- paste0(plot_path, "6_gene_modules/")
dir.create(curr.plot_path, recursive = TRUE)
...
# save pheno data
write.table(antler_data, file = paste0(antler_dir, "phenoData.csv"), row.names = T, sep = "\t", col.names = T)
# save count data
write.table(GetAssayData(norm.data.clustfilt.cc, assay = "RNA", slot = "counts"), file = paste0(antler_dir, "assayData.csv"), row.names = T, sep = "\t", col.names = T, quote = F)

# Load data into antler
antler <- Antler$new(output_folder = curr.plot_path, num_cores = 4)
antler$load_dataset(folder_path = antler_dir)
...
png(paste0(curr.plot_path, 'allmodules.png'), height = 150, width = 120, units = 'cm', res = 500)
...
png(paste0(curr.plot_path, 'DE.GM.png'), height = 160, width = 80, units = 'cm', res = 500)
...
png(paste0(curr.plot_path, 'network.GM.png'), height = 33, width = 55, units = 'cm', res = 1200)
...
# Set plot path
curr.plot_path <- paste0(plot_path, "7_neural_subset/")
dir.create(curr.plot_path)
...
# Set plot path
curr.plot_path <- paste0(plot_path, "8_pseudotime/")
dir.create(curr.plot_path)
