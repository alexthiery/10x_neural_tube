...
dev.off()
```
![Alt text](https://github.com/alexthiery/10x_neural_tube/blob/Dev/R/plots/1_seurat_full/0_filt_data/elbowplot.pdf)
...
```
![Alt text](https://github.com/alexthiery/10x_neural_tube/blob/Dev/R/plots/1_seurat_full/0_filt_data/UMAP_PCA_comparison.pdf)
