...
include {cat as concatenateGTF} from "$baseDir/../modules/cat/cat.nf"
...
workflow {
    concatenateGTF( ch_gtf, file(params.erni_gtf ) )
    modifyGTF( concatenateGTF.out, file(params.wGenes) )
