...
tenx.pheatmap2 <- function(data, metadata, primary_ordering = metadata[1], secondary_ordering = NULL, tertiary_ordering = NULL,
                    ...
                    selected_genes, colour_scheme = c("RdYlBu", "PRGn", "Greys"),
                    main = '', hide_annotation = NULL, show_rownames = T, hclust_rows = F, hclust_cols = F, gaps_col = NULL,
                    cell_subset = NULL, treeheight_row = 0){
